    ...
    <section className='pt-32 pb-20 space-y-16'>
        ...
        <div className="mx-auto max-w-7xl space-y-14 pb-4">
            <div className="w-full">
                ...
                <img className="hidden min-[772px]:block" src="https://nikearprod.vtexassets.com/assets/vtex.file-manager-graphql/images/5473f0cd-16d7-464c-94ca-fa3de5b0967d___d960ce177baf1c68c1c8e74f7a259a3b.jpg" alt="Foto de zapatillas Nike Air Force 1" />
            </div>
            <div className="flex flex-col items-center gap-4">
                <p className="text-3xl md:text-[50px] font-black">AIR FORCE</p>
                <Link className="bg-black rounded-full text-white px-6 py-3 font-bold text-sm hover:bg-red-600 transition-all duration-300" to={`/item/1`}>Comprar</Link>
            </div>
        </div>
        <div className="mx-auto max-w-7xl space-y-14 pb-4'">
