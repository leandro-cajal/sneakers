  ...
  return (
    <>
      <div className='max-w-7xl mx-auto py-32'>
        ...
        {cart.length < 1 ?
          (<div className='p-6 mx-4 xl:mx-0 bg-white flex flex-col gap-8'>
          ...
          (
            <div className='grid lg:grid-cols-3 px-4 lg:px-0 gap-6 w-full'>
              <div className='col-span-2 md:col-span-4 lg:px-0 px-4 w-full bg-gray-50 overflow-hidden shadow-md'>
              ...
              <div className='col-span-2 lg:col-span-1 lg:order-2 bg-white shadow-md h-fit '>
                <div className='p-4 flex flex-col gap-4'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <div>
                      <Link to="/checkout">
                        <button className='text-lg text-white py-3 rounded bg-red-600 w-full hover:opacity-70 transition-colors'>Finalizar Compra</button>
                      </Link>
                    </div>
                  </div>
                </div>
